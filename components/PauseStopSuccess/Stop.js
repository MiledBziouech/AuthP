...
export default function Stop() {
  ...
  return (
    <View style={styles.mainContainer}>
        <Image source={require('../../assets/PauseStopSuccess/Stop.png')} style={{width: 80, height: 80}} />
     
        <View style={styles.textContainer}>
                <Text style={styles.text1}>Stopped</Text>
                <Text style={styles.allText}><Text style={styles.text2}>Congratulations </Text>, you have</Text>
                <Text style={styles.allText}>Stopped at  <Text style={styles.text2}>{min}</Text> mins !</Text>
